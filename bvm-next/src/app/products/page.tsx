...
export default function ProductsPage() {
    ...
    return (
        <div className="page-container min-h-screen">
            {/* Header Section */}
            <section className="relative py-20 lg:py-28 px-4 sm:px-8 lg:px-[8vw] bg-bvm-navy-light mt-20">
                <div className="max-w-4xl">
                    <div className="text-bvm-blue font-bold tracking-widest text-sm uppercase mb-4">OUR PRODUCTS</div>
                    <h1 className="text-4xl md:text-6xl font-display font-bold text-white mb-6">
                        Products & Services
                    </h1>
                    <p className="text-bvm-gray text-lg max-w-2xl">
