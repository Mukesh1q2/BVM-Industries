...
import { products, machineSeries } from "@/data/products";
    ...
    <div className="page-container bg-gray-50 dark:bg-[#080d1a] min-h-screen pb-20">
      <div className="container mx-auto px-4 py-8 pt-24">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            Build Techno-Commercial Offer
          </h1>
          <p className="text-gray-600 dark:text-bvm-gray">
            Generate an authoritative engineering proposal for your clients.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 print:block">
          ...
          <div className="lg:col-span-5 space-y-6 print:hidden">
              ...
              {activeTab === "specs" && (
                <div className="space-y-4 animate-fadeIn">
                  <div className="bg-bvm-blue/10 dark:bg-bvm-blue/20 text-bvm-blue p-3 rounded-lg flex gap-2 text-sm mb-4">
                    ...
                    <p>
                      These details populate the "Production / Application
                      Details" section of the proposal.
                    </p>
                  </div>
                  <div>
                    <label className="block text-gray-900 dark:text-white text-sm font-medium mb-1">
                    ...
                    <input
                      ...
                      className="form-input w-full"
                      placeholder="e.g. Form Fill Seal Machine"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                  ...
                  <div className="pt-4 border-t border-gray-200 dark:border-white/10 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-gray-600 dark:text-bvm-gray text-xs mb-1">
                          Product/App
                        </label>
                        <input
                          type="text"
                          value={formData.productionApp}
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              productionApp: e.target.value,
                            })
                          }
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={formData.mouldMaterial}
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              mouldMaterial: e.target.value,
                            })
                          }
                          className="form-input w-full text-sm py-2"
                        />
              ...
              {activeTab === "pricing" && (
                <div className="space-y-4 animate-fadeIn">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={addItem}
                      className="flex items-center gap-1 text-bvm-blue hover:text-bvm-blue-dark text-xs font-semibold px-3 py-1 bg-bvm-blue/10 rounded-md"
                    >
                  ...
                  <div className="space-y-3">
                    {formData.items.map((item) => (
                      <div
                        key={item.id}
                        className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg p-3"
                      >
                        <div className="space-y-3">
                          <div>
                            <label className="block text-gray-600 dark:text-bvm-gray text-xs font-medium mb-1">
                              Description
                            </label>
                            <div className="relative">
                              <input
                                ...
                                placeholder="Select or type custom machinery/service..."
                                className="form-input w-full py-2 pr-10 text-sm bg-white dark:bg-white/5"
                                list={`datalist-${item.id}`}
                              />
                              <datalist id={`datalist-${item.id}`}>
                                <optgroup label="Main Systems">
                                  {machineSeries.map((m) => (
                                    <option key={m.id} value={`${m.title} - ${m.subtitle}`} />
                                  ))}
                                </optgroup>
                                <optgroup label="Products & Moulds">
                                  {products.map((p) => (
                                    <option key={p.id} value={p.name} />
                                  ))}
                                </optgroup>
                                <option value="Custom Factory Acceptance Test (FAT)" />
                                <option value="Installation & Commissioning" />
                                <option value="Spare Parts Kit (2 Years)" />
                              </datalist>
                          ...
                          <div className="grid grid-cols-12 gap-3">
                            ...
                            <div className="col-span-2 flex items-end">
                              <button
                                ...
                                className="w-full h-[38px] flex items-center justify-center text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-colors border border-red-500/20 disabled:opacity-50"
                              >
                  ...
                  <div className="pt-4 border-t border-gray-200 dark:border-white/10 space-y-2 text-sm">
                    <div className="flex justify-between text-gray-600 dark:text-bvm-gray">
                    ...
                    <div className="flex justify-between text-gray-900 dark:text-white font-bold text-base pt-2">
                      <span>Total Commercial Base</span>
                      <span className="text-bvm-blue">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="btn-secondary flex-1 py-3 justify-center lg:hidden print:hidden"
              >
                {showPreview ? "Hide Preview" : "Show Document"}
              </button>
              <button
                onClick={handlePrint}
                className="btn-primary flex-1 py-3 justify-center print:hidden"
              >
          ...
          <div
            className={`lg:col-span-7 ${showPreview ? "block" : "hidden lg:block"} print:block print:w-full print:col-span-12`}
          >
            <div className="h-[85vh] overflow-y-auto print:h-auto print:overflow-visible custom-scrollbar rounded-xl border border-gray-200 dark:border-white/10 bg-gray-100 shadow-inner p-4 md:p-8 print:border-none print:shadow-none print:bg-white print:p-0">
              <div
                ref={printRef}
              ...
              >
                ...
                <div className="page-break-after p-8 md:p-12 border-b-8 border-bvm-blue">
                  <div className="flex justify-between items-start mb-12">
                    <div className="flex flex-col gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-bvm-blue font-medium mt-1">
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded p-6 mb-12">
                    <h2 className="text-xl font-bold text-gray-900 mb-6 text-center underline">
                      TECHNO-COMMERCIAL OFFER
                    </h2>
                    <table className="w-full text-sm text-gray-800">
                      <tbody>
                        <tr>
                          <td className="py-2 font-semibold w-32">Client</td>
                          <td className="py-2">
                        ...
                        <tr>
                          ...
                          <td className="py-2">: {formData.projectScope}</td>
                        </tr>
                        <tr>
                          <td className="py-2 font-semibold">Offer No.</td>
                          <td className="py-2">: {formData.quotationNumber}</td>
                        </tr>
                        <tr>
                          <td className="py-2 font-semibold">Model</td>
                          <td className="py-2">: {formData.modelNumber}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div className="space-y-4 text-gray-800 text-sm leading-relaxed">
                    <h3 className="font-bold underline pb-2">
                      Subject: Quotation for {formData.productName}
                    </h3>
                    <p>Dear Sir / Madam,</p>
                    <p>
                      We thank you for your interest in BVM Industries and for
                      the opportunity to submit our techno-commercial offer for
                      your requirement of {formData.productName}.
                    </p>
                    <p>
                      We are pleased to submit our technical and commercial
                      proposal for your review. This offer has been prepared
                      based on the available requirement details and applicable
                      project scope. In case of any clarification, our team will
                      be glad to assist.
                    </p>
                    <br />
                    <p>Regards,</p>
                ...
                <div className="page-break-after p-8 md:p-12">
                  <h2 className="text-lg font-bold bg-bvm-blue text-white p-2 mb-6">
                    Contents
                  </h2>
                  <table className="w-full text-sm text-gray-800 mb-12 border border-gray-200">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="text-left p-2 border-b">Sr. No.</th>
                    ...
                    <tbody>
                      <tr className="border-b">
                        ...
                        <td className="p-2">Introduction – BVM Industries</td>
                      </tr>
                      <tr className="border-b">
                      ...
                      <tr className="border-b">
                        ...
                        <td className="p-2">
                          Utility / Environment Requirements
                        </td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2">4</td>
                        <td className="p-2">
                          Machine / Product Details & Specifications
                        </td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2">5</td>
                        <td className="p-2">Commercial Quotation</td>
                      </tr>
                      <tr>
                        <td className="p-2">6</td>
                        <td className="p-2">Terms and Conditions</td>
                      </tr>
                    </tbody>
                  </table>

                  <h2 className="text-lg font-bold bg-gray-100 p-2 mb-4 border-l-4 border-bvm-blue text-gray-900">
                    1. Introduction – BVM Industries
                  </h2>
                  <p className="text-sm text-gray-800 mb-8 leading-relaxed">
                    BVM Industries is a manufacturer of pharmaceutical packaging
                    machinery and precision engineering solutions. We design and
                    supply Blow Fill Seal Machines, Form Fill Seal Machines,
                    Euro Cap Sealing Machines, precision moulds, refurbishment
                    solutions, and turnkey project systems for regulated
                    production environments.
                  </p>

                  <h2 className="text-lg font-bold bg-gray-100 p-2 mb-4 border-l-4 border-bvm-blue text-gray-900">
                    2. Production / Application Details
                  </h2>
                  <ul className="list-disc pl-5 text-sm text-gray-800 space-y-2 mb-8">
                    <li>
                      <strong>Product / Application:</strong>{" "}
                      {formData.productionApp}
                    </li>
                    <li>
                      <strong>Fill Volume:</strong> {formData.fillVolume}
                    </li>
                    <li>
                      <strong>Container Type:</strong> {formData.containerType}
                    </li>
                    <li>
                      <strong>Mould Design:</strong> As per approved URS /
                      drawing / final customer confirmation
                    </li>
                    <li>
                      <strong>Mould Material:</strong> {formData.mouldMaterial}
                    </li>
                    <li>
                      <strong>Product Output:</strong> {formData.productOutput}
                    </li>
                    <li>
                ...
                <div className="page-break-after p-8 md:p-12">
                    ...
                    <tbody>
                      <tr className="border-b">
                        ...
                        <td className="p-2 border-r">
                          Compressed Air Supply with FRL
                        </td>
                        <td className="p-2 text-gray-400">Client spec</td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2 border-r">2</td>
                        <td className="p-2 border-r">Chiller for mould</td>
                        <td className="p-2 text-gray-400">Client spec</td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2 border-r">3</td>
                        <td className="p-2 border-r">
                          Cooling water for barrel cooling
                        </td>
                        <td className="p-2 text-gray-400">Client spec</td>
                      </tr>
                      <tr className="border-b">
                      ...
                      <tr>
                        ...
                        <td className="p-2 border-r">
                          Pure Steam / SIP (If applicable)
                        </td>
                        <td className="p-2 text-gray-400">Process dependent</td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table className="w-full text-sm text-gray-800 border border-gray-300 mb-8 font-mono text-xs">
                    <thead>
                      <tr className="bg-gray-100 border-b">
                        <th className="p-2 text-left w-12 border-r">No.</th>
                        <th className="p-2 text-left border-r">Item</th>
                    ...
                    <tbody>
                      <tr className="border-b">
                        <td className="p-2 border-r">1</td>
                        <td className="p-2 border-r">Machine Frame</td>
                        <td className="p-2">SS304 Covered</td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2 border-r">2</td>
                        <td className="p-2 border-r">
                          Filling Unit and Nozzles
                        </td>
                        <td className="p-2 font-bold text-bvm-blue">SS316L</td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2 border-r">3</td>
                        <td className="p-2 border-r">
                          CIP / SIP / Product Contact Pipes
                        </td>
                        <td className="p-2 font-bold text-bvm-blue">SS316L</td>
                      </tr>
                      <tr className="border-b">
                        ...
                        <td className="p-2">SS304</td>
                      </tr>
                      <tr>
                        <td className="p-2 border-r">5</td>
                        <td className="p-2 border-r">Moulds</td>
                        <td className="p-2">{formData.mouldMaterial}</td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table className="w-full text-sm text-gray-800 border border-gray-300 mb-4">
                    ...
                    <tbody>
                      ...
                      <tr className="bg-gray-100">
                        ...
                        <td className="p-3 text-right font-extrabold text-bvm-blue">
                          {formatCurrency(calculateTotal())}
                        </td>
                      </tr>
                    </tbody>
                  ...
                  <h2 className="text-lg font-bold bg-gray-100 p-2 mt-8 mb-4 border-l-4 border-bvm-blue text-gray-900">
                    6. Terms and Conditions
                  </h2>
                  <ul className="list-disc pl-5 text-xs text-gray-700 space-y-2">
                    <li>
                      <strong>Prices:</strong> Ex-Works Baddi, Himachal Pradesh.
                    </li>
                    <li>
                      <strong>Taxes:</strong> GST/IGST extra as applicable
                      (Calculated at 18%).
                    </li>
                    <li>
                      <strong>Payment:</strong> 30% advance along with PO, 70%
                      against PI before dispatch.
                    </li>
                    <li>
                      <strong>Delivery:</strong> 12-16 weeks from receipt of
                      advance and approved drawings.
                    </li>
                    <li>
                      <strong>Warranty:</strong> 12 months from commissioning
                      against manufacturing defects.
                    </li>
                    {formData.notes && (
                      <li className="text-red-700 mt-2 font-medium">
                        <strong>Special Note:</strong> {formData.notes}
                      </li>
                    )}
                  </ul>
                </div>
                ...
                <div className="border-t-2 border-gray-200 p-6 flex flex-wrap gap-4 text-xs justify-between text-gray-500 bg-white">
                  <div className="flex gap-4">
                    <span className="flex items-center gap-1">
                      <MapPin className="w-3 h-3" /> Plot No. 774/496/46,
                      Village Gullarwala, Baddi, H.P. 173205
                    </span>
                  </div>
                  <div className="flex gap-4">
                    <span className="flex items-center gap-1">
                      <Phone className="w-3 h-3" /> +91 7018231499
                    </span>
                    <span className="flex items-center gap-1">
                      <Mail className="w-3 h-3" /> sales@mybvm.in
                    </span>
                  </div>
                </div>
              </div>
      ...
      <style>{`
                ...
                @media print {
                    ...
                    /* Hide Web UI specific scrollbars */
                    .custom-scrollbar {
