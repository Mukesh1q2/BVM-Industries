            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="ss-filter-housing" className="bg-bvm-navy">Sanitary Stainless Steel Filter Housings</option>
                  <option value="hydraulic-cylinders" className="bg-bvm-navy">Industrial Hydraulic Cylinders & Manifolds</option>
                  <option value="turnkey_cleanroom" className="bg-bvm-navy">Turnkey Cleanroom (Class 100) Integration</option>
                  <option value="ga-drawing-request" className="bg-bvm-navy">G.A. Drawing / Technical Blueprint Request</option>
                  <option value="custom_engineering" className="bg-bvm-navy">Custom Engineering & Validation Services</option>
                  <option value="other" className="bg-bvm-navy">Other Engineering Inquiry</option>
                </select>
              </div>
