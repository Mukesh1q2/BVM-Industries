                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
                    ...
                    <div className="p-4 group">
                        <div className="flex items-center justify-center gap-3 mb-2">
                            ...
                            <h3 className="text-3xl font-display font-bold text-white">Class 100</h3>
                        </div>
                        <p className="text-bvm-gray text-sm uppercase tracking-wider font-medium">Aseptic Chambers</p>
                    </div>
