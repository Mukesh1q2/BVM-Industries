                    ...
                    <div className="bg-gradient-to-r from-bvm-blue/20 to-bvm-navy border border-bvm-blue/30 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
                        <div className="flex-1">
                            ...
                            <p className="text-bvm-gray mb-6">
                                We understand the stringent requirements of the pharmaceutical industry. Our machines are designed to comply with US FDA, MHRA, and WHO-GMP guidelines, ensuring a smooth validation process for our clients.
                            </p>
