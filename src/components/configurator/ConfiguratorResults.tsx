...
import { ArrowRight, Download, CheckCircle, Factory } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                ...
                <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm flex flex-col items-center text-center">
                    ...
                    <div className="mt-auto w-full space-y-4">
                        ...
                        <button className="w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white px-6 py-4 rounded-xl font-bold transition-all border border-white/10">
                            <Download className="w-5 h-5" /> Download Preliminary BOM
                        </button>
                    </div>
                </div>
