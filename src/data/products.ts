...
export const products: Product[] = [
  ...
  },
  {
    ...
    shortDescription: 'BFS mould machine for 50 ml aseptic packaging format',
    fullDescription: 'Specialized Blow Fill Seal mould machine designed for 50 ml format production. Features precision cavity manufacturing and is suitable for Class 100 aseptic packaging systems in pharmaceutical environments.',
    features: [
      ...
      'Suitable for SVP/LVP applications'
    ],
    specifications: {
      'Container Volume': '50 ml',
      'Output Capacity': '3,000 - 5,000 units/hour',
      'Cavity Configuration': '8-16 cavities',
